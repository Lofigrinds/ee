...
ShowerLib2.Settings.Default.ItemTextColor = Color3.fromRGB(136, 8, 8);
ShowerLib2.Settings.Default.ButtonBackgroundColor = Color3.fromRGB(255, 68, 51)
ShowerLib2.Settings.Default.TextBoxBackgroundColor = Color3.fromRGB(204, 85, 0)
ShowerLib2.Settings.Default.SideBarBackgroundColor = Color3.fromRGB(210, 4, 45)
ShowerLib2.Settings.Default.PageIndicatorBackgroundColor = Color3.fromRGB(16, 16, 16)

--PageIndicator
--Color3.fromRGB(28, 28, 28)

local UIName = tostring(math.random(1, 100))..tostring("TT Grinds")..tostring(math.random(1, 100))
